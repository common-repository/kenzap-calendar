...
function kenzap_calendar_list_editor_assets() {
	...
	wp_enqueue_script(
        ...
        KENZAP_CALENDAR_VERSION, // Version: filemtime — Gets file modification time.
    ...
    if ( has_blocks( $post_object ) ) {
        ...
        foreach ($blocks as $block) {
            if ($block['blockName'] == 'kenzap/calendar-1') {
                ...
                wp_enqueue_script( 'kenzap/calendar-1-script', plugins_url( 'calendar-1/script.js', __FILE__ ), array('jquery'), KENZAP_CALENDAR_VERSION );
