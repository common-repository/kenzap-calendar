...
Contributors: kenzap
Tags: appointment booking, booking calendar, booking system, reservation calendar 
...
Display calendar section for appointments reservations or bookings. Specify custom time slots. Link checkout process with WooCommerce. This plugin is linked with popular MyTicket Events plugin so that you can connect seat reservation charts and sell tickets for venues.
...
= v1.0.5 =
Update: block freezing when wrong dates selected. Now fixed.

= v1.0.6 =
New: link calendar with MyTicket events plugin
Update: fixing crash immediately after adding the calendar